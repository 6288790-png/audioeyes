import{a as e}from"./lil-gui.esm-jlbWO7FJ.js";import{Bt as t,Jn as n,Wt as r,_t as i,ar as a,g as o,l as s,qn as c,r as l,u,wr as d,yt as f}from"./three.module-CgISyWQV.js";import{n as p,r as m,t as h}from"./OutputPass-D9GSoAm2.js";import{t as g}from"./UnrealBloomPass-1z79deN3.js";import{i as _,n as v,r as y,t as b}from"./GUIHelper-DspWBXk2.js";import{t as x}from"./OrbitControls-DVnblHSy.js";var S=class{constructor(e,t={}){this.canvas=e,this.TRAIL_COUNT=5e3,this.TRAIL_LENGTH=20;let n={particleSize:3,morphDrive:1,morphAmount:1,bloomStrength:.1,bloomRadius:.15,bloomThreshold:.8,bloomBeatResponse:.1,audioBassImpact:1,audioMidImpact:1,audioHighImpact:1,autoRotate:!1,flowStrength:.08,particleCount:15e4,trailGlow:.8,kickImpact:.2,downbeatImpact:1,particleBrightness:1,cameraPosition:{x:0,y:25,z:20},color:`#ffd43b`,hueVariation:.5,saturationBoost:1.8};this.settings={...n,...t},this.defaultSettings=n,this.scene=null,this.camera=null,this.renderer=null,this.controls=null,this.composer=null,this.bloomPass=null,this.particleSystem=null,this.particleMaterial=null,this.particleGeometry=null,this.trailMesh=null,this.trailMaterial3D=null,this.bass=0,this.mid=0,this.high=0,this.kickDetected=0,this.snareDetected=0,this.hihatDetected=0,this.downbeatDetected=0,this.motion=0,this.variation=0,this.energy=0,this.percussive=0,this.smoothness=0,this.hasAudioData=!1,this.morphValue=0,this.autoMin=.15,this.autoMax=.85,this.morphSlow=.5,this.prevFast=.5,this.morphTransient=0,this.hue=.13,this.baseHue=this.hexToBaseHue(this.settings.color),this.elapsedTime=0,this.lastFrameTime=0,this.gui=null,this.guiContainer=null,this.guiVisible=!1,this.settingsButton=null,this.isRebuilding=!1,this.init().catch(e=>{console.error(`❌ Animation10 初始化失败:`,e)})}async init(){try{return await this.setupThreeJS(),this.createParticles(this.settings.particleCount),this.createRibbonTrail(),this.setupPostProcessing(),this.setupGUI(),this.setupSettingsButton(),console.log(`✅ Animation10 初始化成功`),!0}catch(e){throw console.error(`❌ Animation10 初始化失败:`,e),e}}async setupThreeJS(){this.scene=new c,this.camera=new t(45,window.innerWidth/window.innerHeight,.1,1e3),this.camera.position.set(this.settings.cameraPosition.x,this.settings.cameraPosition.y,this.settings.cameraPosition.z),this.camera.lookAt(0,0,0),this.renderer=new l({canvas:this.canvas,antialias:!0,alpha:!0,powerPreference:`high-performance`,toneMapping:4,toneMappingExposure:1}),this.renderer.outputColorSpace=i,this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setClearColor(0,0),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.canvas.style.backgroundColor=`transparent`,this.canvas.style.zIndex=`1`,this.controls=new x(this.camera,this.canvas),this.controls.enableDamping=!0,this.controls.autoRotate=!1,this.controls.target.set(0,0,0),this.controls.minDistance=1.5,this.controls.maxDistance=25,this.controls.enablePan=!0,this.controls.mouseButtons={LEFT:f.ROTATE,MIDDLE:f.DOLLY,RIGHT:f.PAN},this.controls.touches={ONE:a.ROTATE_PAN,TWO:a.DOLLY_PAN}}createParticles(e){this.particleSystem&&(this.scene.remove(this.particleSystem),this.particleGeometry&&this.particleGeometry.dispose(),this.particleMaterial&&this.particleMaterial.dispose());let t=Math.floor(e),i=new u;this.particleGeometry=i;let a=new Float32Array(t*3),c=new Float32Array(t),l=new Float32Array(t),d=new Float32Array(t*3),f=new Float32Array(t*3),p=new Float32Array(t),m=new Float32Array(t),h=Math.max(1,Math.floor(t/16));for(let e=0;e<t;e++){let t=e%16,n=(Math.floor(e/16)+.5)/h,r,i;t<8?(r=t/8*Math.PI*2,i=n*Math.PI):(i=(t-8+.5)/8*Math.PI,r=n*Math.PI*2);let o=3+Math.random()*.05,s=Math.sin(i)*Math.cos(r)*o,u=Math.cos(i)*o,g=Math.sin(i)*Math.sin(r)*o;a[e*3+0]=s,a[e*3+1]=u,a[e*3+2]=g,d[e*3+0]=s,d[e*3+1]=u,d[e*3+2]=g,c[e]=Math.random(),l[e]=.15+Math.random()*.25,f[e*3+0]=(Math.random()-.5)*.004,f[e*3+1]=(Math.random()-.5)*.004,f[e*3+2]=(Math.random()-.5)*.004,p[e]=Math.random(),m[e]=Math.random()*100}i.setAttribute(`position`,new s(a,3)),i.setAttribute(`seed`,new s(c,1)),i.setAttribute(`size`,new s(l,1)),i.setAttribute(`basePos`,new s(d,3)),i.setAttribute(`velocity`,new s(f,3)),i.setAttribute(`lifePhase`,new s(p,1)),i.setAttribute(`flowSeed`,new s(m,1)),this.particleMaterial=new n({transparent:!0,depthWrite:!1,blending:2,uniforms:{time:{value:0},particleSize:{value:this.settings.particleSize},morph:{value:0},morphAmount:{value:this.settings.morphAmount},bass:{value:0},mid:{value:0},high:{value:0},flowStrength:{value:this.settings.flowStrength},kickDetected:{value:0},snareDetected:{value:0},hihatDetected:{value:0},motion:{value:0},brightness:{value:this.settings.particleBrightness},uColor:{value:new o(this.settings.color)},uHueShift:{value:0},uColorIntensity:{value:1},uBrightnessFeat:{value:0},uDownbeat:{value:0},uTime:{value:0},uVariation:{value:0}},vertexShader:`
                uniform float time;
